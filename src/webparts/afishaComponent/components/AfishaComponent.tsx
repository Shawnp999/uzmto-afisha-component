...
export default class AfishaComponent extends React.Component<IAfishaComponentProps, {}> {
  public render(): React.ReactElement<IAfishaComponentProps> {
    ...
    return (
      <section className={`${styles.afishaComponent} ${hasTeamsContext ? styles.teams : ''}`}>
